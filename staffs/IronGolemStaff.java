...
public class IronGolemStaff extends Item {

public IronGolemStaff() {
...
EntityIronGolem entity = spawnEnt(world, (
...
*/
public static EntityIronGolem spawnEnt(World world, double x, double y, double z) {
