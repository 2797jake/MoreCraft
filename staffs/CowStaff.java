...
public class CowStaff extends Item {
...
EntityCow entity = spawnEnt(world, (
...
*/
public static EntityCow spawnEnt(World world, double x, double y, double z) {
EntityCow entity = new EntityCow(world);
