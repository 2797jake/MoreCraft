...
public class SkeletonStaff extends Item {

public SkeletonStaff() {
...
EntitySkeleton entity = spawnEnt(world, (
...
*/
public static EntitySkeleton spawnEnt(World world, double x, double y, double z) {
